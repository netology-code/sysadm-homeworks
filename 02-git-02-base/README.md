...
1. Научитесь создавать и настраивать репозиторий для работы в GitLab и bitbucket 
2. Поработаете с тегами
3. Создадите новые ветки
4. Попробуете поработь с Git при помощи визуального редактора
