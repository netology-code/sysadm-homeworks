...
В результате выполнения этого задания вы научитесь работать с git, как с распределнной системой контроля версий.  

1. Научитесь создавать и настраивать репозиторий для работы в Github, GitLab и Bitbucket. 
2. Поработаете с тегами.
3. Попробуете поработь с Git при помощи визуального редактора.
