...
4. Поработаете с unshare и nsenter для понимания как создать отдельный namespace для процесса (частичная контейннеризация).
...
1. Документация по systemd unit файлам - https://www.freedesktop.org/software/systemd/man/systemd.service.html
2. Документация по параметрам sysctl - https://www.kernel.org/doc/Documentation/sysctl/
