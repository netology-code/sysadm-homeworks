...
3. Построите сетевую диаграмму, что поможет в дальнейшем работать с сетевыми диаграммами.

------

### Чеклист готовности к домашнему заданию

1. Убедитесь, что у вас установлен `telnet`. Воспользуйтесь пакетным менеджером apt для установки.
