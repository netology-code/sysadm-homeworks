...
Домашнее задание выполните в файле readme.md в github репозитории или в Google Doc.
...
*Что привести в качестве выполненного задания???*

`5. Добавьте свое имя в каждый файл (какой файл????) - надо ли его приводить в качесвте сделанного задания??, сделайте снимок экран и загрузите его на любой сервис обмена картинками.  
