...
1. Научитесь создавать и настраивать репозиторий для работы
2. Познакомитесь с документацией по GIT
...
1. Домашнее задание выполните в файле readme.md в github репозитории. 
2. В личном кабинете отправьте на проверку ссылку на .md-файл в вашем репозитории.
...
12. И еще раз выполните команды `git diff` и `git diff --staged`. Поиграйте с изменениями и этими коммандами, чтобы четко понять
...
`*Что-то надо приложить в качестве ответа на данное задание?*`
